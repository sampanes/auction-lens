...
REM
REM schedule.cmd owns every actual run time and points each task at this file.
REM Runs may see the same lots: the private delivery ledger is what keeps a
