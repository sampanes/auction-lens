...
from auction_lens.nellis_ingest import canonicalize_nellis_product
...
def _canonical_grade(product: dict) -> dict[str, str]:
    row = canonicalize_nellis_product(product, page_url="https://example.invalid/product")
    return row["grade"]
